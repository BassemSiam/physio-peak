...
function MapContent() {
  const handleDirections = () => {
    // Fixed the Google Maps URL
    const url = `https://www.google.com/maps/search/?api=1&query=${clinicPos[0]},${clinicPos[1]}`;
    ...
    <div className="h-120 w-full overflow-hidden rounded-xl border border-gray-200 shadow-lg">
      ...
      >
        ...
        <Marker position={clinicPos} icon={customIcon}>
          {/* Added closeButton={false} to keep it open forever */}
